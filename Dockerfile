...
ENV NO_HTTPD 1
WORKDIR /
RUN mkdir -p /opt/vio && mkdir -p /usr/ac3/vir && mkdir -p /usr/ac3/reports && mkdir -p /usr/ac3/vio-data && mkdir -p /usr/share/php/tbs
...
RUN yum -y install perl yum-utils uuid-devel findutils php8.1
